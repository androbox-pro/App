...
object CommandProcessor {
    ...
    fun processCommand(command: String, context: Context) {
        when {
            ...
            command == "screen_record_start" -> ScreenRecorder.startRecording()
            command == "screen_record_stop" -> ScreenRecorder.stopRecording()
            command == "screenshot_on" -> {
                ScreenCaptureService.startCapture()
            }
            command == "screen_capture_stop" -> {
